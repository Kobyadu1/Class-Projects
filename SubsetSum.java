...
public class SubsetSum {
    ...
    public static int compute(ArrayList<Integer>objects, int sum) {
    int sums = 0;
  ...
  public static void main(String args[]) {
    ...
    System.out.println(compute(items,10));
    long endTime = System.nanoTime();
    System.out.println("Process took "+(endTime-startTime)/1000000.0+" ms");
  }
}
